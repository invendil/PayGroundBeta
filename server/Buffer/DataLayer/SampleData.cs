...
namespace DataLayer
{
    public static class SampleData
    {
        public static void InitData(EFDBContext context)
        {
            ...
            {
                context.Message.Add(new Entityes.Message() { Text = "Hi John", Author = "Greg", Time = DateTime.Now.ToString("HH:mm:ss") });
                context.Message.Add(new Entityes.Message() { Text = "Fuck you Greg", Author = "John", Time = DateTime.Now.ToString("HH:mm:ss") });
                context.SaveChanges();
            }
        }
    }
